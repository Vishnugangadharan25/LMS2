...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\LENOVO\Desktop\CRUD App In Django\env'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\LENOVO\Desktop\CRUD App In Django\env\Scripts\deactivate.nu'
